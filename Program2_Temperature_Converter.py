...
fahrenheit_temperature = int(input("Please enter a temperature in Fahrenheit: "))  # input statement

# 2. Convert Fahrenheit to Kelvin: kelvin (fahrenheit + 459.67 * 5/9)
kelvin = (fahrenheit_temperature + 459.67) * 5/9  # assignment statement

# 3. Display the kelvin: print Fahrenheit temperature "degress in Fahrenheit =" Kelvin
print( fahrenheit_temperature, "degrees in Fahrenheit    =   ", format(kelvin, '.2f'), "in Kelvin")  # output statement
